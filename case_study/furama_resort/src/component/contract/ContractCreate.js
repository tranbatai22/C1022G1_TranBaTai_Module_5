                ...
                <form className="w-50 border border-2 border-success p-3 rounded">
                    <div className="form-group">
                        ...
                        <div className="input-group">
                            <input type="text" id="idContract" className="form-control" placeholder="Nhập mã hợp đồng"
                                   name="idContract"/>
                    ...
                    <div className="mt-3 form-group">
                        ...
                        <input type="date" id="startDay" className="form-control" name="startDay"/>
                    </div>
                    ...
                    <div className="mt-3 form-group">
                        <label htmlFor="money" style={{fontWeight: "bold"}}>SỐ tiền cọc:<span
                            style={{color: "red"}}>*</span></label>
                        <div className="input-group">
                            <input type="text" id="money" className="form-control" placeholder="Nhập số tiền cọc"
                                   name="money"/>
                            <span className="input-group-text"/>
                        </div>
                    </div>
                    ...
                    <div className="mt-3 form-group">
                        ...
                        <div className="input-group">
                            <input type="text" id="total" className="form-control"
                                   placeholder="Nhập tổng tiền thanh toán" name="total"/>
                            <span className="input-group-text"/>
                        </div>
                    </div>
